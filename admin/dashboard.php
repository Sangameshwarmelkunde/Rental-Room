...
<!DOCTYPE html>
<head>
<title>Room Allocation System | dashboard </title>
...
?>
					<div class="col-md-8 market-update-left">
					<h4><a href="manage-ownerdetails.php" style="color: white">Total Room Owner</a></h4>
...
?>
					<div class="col-md-8 market-update-left">
					<h4><a href="manage-pgdetails.php" style="color: white">Total Room</a></h4>
