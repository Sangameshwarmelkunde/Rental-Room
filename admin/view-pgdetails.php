...
<!DOCTYPE html>
<head>
<title>Room Allocation System  | Room Form </title>
...
?>
    ...
    <td><?php  echo $row['FullName'];?></td>
                    ...
                    <tr>
    <th>Room Owner Email</th>
    <td><?php  echo $row['Email'];?></td>
  </tr>   
                 <tr>
    <th>Room Owner Mobile Number</th>
...
<label class="col-sm-3 control-label col-lg-3" for="inputSuccess" style="color: red">Facilities</label>
  ...
  <table border="1" class="table table-bordered mg-b-0">
    <label class="col-sm-3 control-label col-lg-3" for="inputSuccess" style="color: red">Meals which offer by Room</label>
  <tr>
    <th>Breakfast</th>
