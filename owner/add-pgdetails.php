...
<section id="main-content">
   ...
   <div class="form-group">
<label class="col-sm-3 control-label">Type of Room:</label>
<div class="col-sm-6">
...
Both
              ...
              <option value="<?php echo $row['StateName'];?>"><?php echo $row['StateName'];?></option>
                  ...
                  <?php } ?> 
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Choose meals which you offer with Room</label>
                        <div class="col-lg-6">
                            <label class="checkbox-inline">
