...
if (strlen($_SESSION['pgasoid']==0)) {
  ...
  $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "update tblowner set FullName ='$fullname', Email='$email', MobileNumber='$mobno' where ID='$ownid'");
    if ($query) {
...
<!DOCTYPE html>
<head>
<title>ROom ALlocation System|| Owner Profile  </title>
