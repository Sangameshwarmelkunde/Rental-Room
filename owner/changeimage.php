...
$roompic=md5($pgpic).$extension;
    ...
    $query=mysqli_query($con, "update tblpg set Image='$roompic' where ID='$cid'");
    if ($query) {
    $msg="PG Image has been Updated.";
  }
  else
    {
...
<!DOCTYPE html>
<head>
<title>Room Allocation System  | Image </title>
...
?>
                <form class="form-horizontal bucket-form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                             <img src="roomimages/<?php echo $row['Image'];?>" width="200" height="150" value="<?php  echo $row['Image'];?>">
                        </div>
                    </div>
                 <div class="form-group">
                        <label class=" col-sm-3 control-label">Pictures</label>
