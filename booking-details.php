...
<head>
    ...
    <!-- Site Title -->
    <title>Room Allocation details | Details</title>
...
<img src="owner/roomimages/<?php echo $row['Image'];?>" alt="" height='350' width="1000" style="border:#000 solid 2px;" ></div>
 <h2 align="center" style="padding-top:2%"><?php echo $row['PGTitle'];?>'s Room Booking Details</h2>
 </div>
...
<tr>
 ...
 <h2 align="center" style="color:blue">Room Details</h2>
  </div>                     
...
<tr>
  ...
  <table border="1" class="table table-bordered mg-b-0">
<tr align="center">
<td style="color: red; font-size: 25px" colspan="2">Meals which offer by Room</td>
</tr>  
  <tr>
    <th>Breakfast</th>
